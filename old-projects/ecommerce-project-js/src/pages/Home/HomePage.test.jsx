...
import userEvent from "@testing-library/user-event"; // this lets us similate events like onclick
...
describe("HomePage Component", () => {
  ...
  it("displays the products  correct", async () => {
    ...
    const productContainers = await screen.findAllByTestId("product-container"); // find waits for untill the element is loaded
